<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Kerimcokurpinar.index" %>
            ...
            <div class="col-lg-8">
               <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <% 
                               // Veritabanından verileri çekmek için gerekli kodlar
                               DataTable dt = new DataTable();
                               using (SqlConnection conn = new SqlConnection(connectionString))
                               {
                                   SqlCommand cmd = new SqlCommand("SELECT * FROM Slider", conn);
                        ...
                        <% 
                            ...
                            <li data-target="#header-carousel" data-slide-to="<%= i %>" <% if (i == 0) { %>class="active"<% } %>></li>
                        <% } %>
                    </ol>
                    <div class="carousel-inner">
                        <% for (int i = 0; i < dt.Rows.Count; i++) { %>
                            <div class="carousel-item position-relative <% if (i == 0) { %>active<% } %>" style="height: 430px;">
                                <img class="position-absolute w-100 h-100" src="<%= dt.Rows[i]["slider_resim"] %>" style="object-fit: cover;"/>
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div class="p-3" style="max-width: 700px;">
                                        <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown"><%= dt.Rows[i]["slider_aciklama"] %></h1>
                                        <p class="mx-md-5 px-5 animate__animated animate__bounceIn"><%= dt.Rows[i]["slider_resim"] %></p>
                                        <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="<%= dt.Rows[i]["slider_link"] %>">ALIŞVERİŞ YAP</a>
                                    </div>
                                </div>
                            </div>
                        <% } %>
        ...
        <div class="product-item bg-light mb-4">
            ...
            <div class="text-center py-4">
                ...
                <div class="d-flex align-items-center justify-content-center mb-1">
                    <a class="btn btn-primary" href="sepet.aspx?urun_id=<%= reader["urun_id"] %>">Sepete Ekle</a>
                </div>
            </div>
        </div>
    </div>
